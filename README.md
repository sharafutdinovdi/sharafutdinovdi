...
<img alt="DevLoader inside Revit 2026: a catalog of five add-ins from a GitHub Releases feed, two installed with one click each, then the feed refreshed" src="assets/revit-devloader.gif" width="100%">
